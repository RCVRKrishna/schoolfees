...
$date = mysqli_real_escape_string($conn,$_POST['date']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (details,amount,date) VALUES ('$details','$amount','$date')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  exapense  SET  expense  = '$expense', details  = '$details', date  = '$date'WHERE  id  = '$id'");
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Add expense": "Edit expense"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">details </label>
								<div class="col-sm-10">
